...
var _danbruder$whiteboard$Native_Canvas = (function() {
      ...
      case 'DrawImage':
        ...
        switch (drawOp._1.ctor) {
          case 'At':
            ...
            ctx.drawImage(srcCanvas, destPoint.x, destPoint.y);
            break;
  ...
  function getImageData(point, size, model) {
    ...
    var ctx = canvas.getContext('2d');
    var imageData = ctx.getImageData(point.x, point.y, size.width, size.height);
